        ...
        <CardFooter>
          <div>
            <a
              ...
              href="https://github.com/szjohanr4"
              target="_blank"
            ...
            <a
              rel="noreferrer noopener"
              href="https://www.instagram.com/johanszr/"
              target="_blank"
              className={buttonVariants({
                variant: "ghost",
                size: "sm",
      ...
      <Card className="absolute w-[350px] -right-[10px] bottom-[-40px]  drop-shadow-xl shadow-black/10 dark:shadow-white/10">
        ...
        <CardFooter>
          <div>
            ...
            <a
              rel="noreferrer noopener"
              href="https://www.instagram.com/jseb4s/"
              target="_blank"
              className={buttonVariants({
                variant: "ghost",
                size: "sm",
            ...
            <a
              rel="noreferrer noopener"
              href="https://www.linkedin.com/in/jsma"
              target="_blank"
              className={buttonVariants({
                variant: "ghost",
                size: "sm",
